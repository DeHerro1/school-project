...
import { CheckCircle2, XCircle, Clock, BellRing, Camera, FileText, Sparkles } from "lucide-vue-next";
import { Card, CardContent, Badge, Avatar, Button, Spinner, EmptyState } from "@repo/ui";
    ...
    <template v-else>
      ...
      <Card v-if="pendingAlerts.length" class="mt-6 border-amber-300 bg-amber-50/60">
        <CardContent class="flex flex-col gap-3 pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button :as="'div'"><NuxtLink to="/alerts">Provide a reason</NuxtLink></Button>
        </CardContent>
      </Card>
      ...
      <div class="mt-6">
        <div class="mb-3 flex items-center justify-between">
          ...
          <NuxtLink to="/photos" class="text-sm text-primary hover:underline">View all</NuxtLink>
        </div>
