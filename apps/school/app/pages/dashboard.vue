...
<template>
  <div>
    ...
    <div v-if="loading">
      <SkeletonStatGrid :count="isTeacher ? 3 : 4" />
      <div class="mt-6 grid gap-6 lg:grid-cols-2">
        <Card><CardContent class="pt-5"><SkeletonList :rows="5" /></CardContent></Card>
        <Card><CardContent class="pt-5"><SkeletonList :rows="5" :avatar="false" /></CardContent></Card>
      </div>
    </div>
